...
public class ViewJTable extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Descrição esta com espaço vazio");
        }
        else{
        ...
        JOptionPane.showMessageDialog(null, "Quantidade esta com espaço vazio");
        }
        else{
        p.setQuantidade(Integer.parseInt(txtDesc.getText()));
        }
         
            if(txtPreco.getText().equals("")){
        JOptionPane.showMessageDialog(null, "Preço esta com espaço vazio");
        }
        else{
